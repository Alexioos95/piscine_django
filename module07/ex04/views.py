...
class HomeRedirectView(RedirectView):
	url = reverse_lazy("ex04:articles")
		
class ArticlesView(ListView):
	model = Article
	template_name = "ex04/articles.html"
...
class ArticleDetailView(DetailView):
	model = Article
	template_name = "ex04/article_detail.html"
...
class LoginView(FormView):
	template_name = "ex04/login.html"
	form_class = AuthenticationForm
	success_url = reverse_lazy("ex04:home")
...
class PublicationsView(LoginRequiredMixin, ListView):
	model = Article
	template_name = "ex04/my_publications.html"
	context_object_name = "articles"
...
class FavouriteArticlesView(LoginRequiredMixin, ListView):
	...
	template_name = "ex04/favourites.html"
...
class RegisterView(CreateView):
	...
	template_name = "ex04/register.html"
	success_url = reverse_lazy("ex04:login")

class PublishArticleView(LoginRequiredMixin, CreateView):
	model = Article
	form_class = ArticleForm
	template_name = "ex04/publish.html"
	success_url = reverse_lazy("ex04:publications")
...
class AddFavouriteView(LoginRequiredMixin, CreateView):
	...
	def get_success_url(self):
		return reverse_lazy("ex04:favourites")
...
class NavLoginView(LoginView):
	...
	def form_invalid(self, form):
		...
		response = render(self.request, "ex04/articles.html", {
			"login_form": form,
		})
