...
class Tip(models.Model):
	...
	author = models.ForeignKey("ex04.MyUser", on_delete=models.CASCADE, related_name="ex05_tips")
...
class Vote(models.Model):
	...
	user = models.ForeignKey("ex04.MyUser", on_delete=models.CASCADE, related_name="ex05_votes")
